    ...
    <Adm title="Admin - Lista de Adms" page="users">
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                <h1 class=" text-3xl font-bold tracking-wide">Lista de Administradores</h1>
                <!-- Start coding here -->
                <div class="bg-white dark:bg-gray-800 mt-3 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr class="border-b dark:border-gray-700" v-for="user in admins.data">
                                    <th class="px-4 py-3">
                                        <input type="checkbox"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                    </th>
                                    ...
                                    <td class="px-4 py-3 gap-2 h-full">
                                        <div class="flex center gap-3">
                                            <button class="bg-red-500 rounded-lg p-2" title="Retirar o privilegio"><i
                                                    class="pi pi-times-circle cursor-pointer text-lg text-white"></i></button>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                        ...
                        <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                            Mostrando
                            <span class="font-semibold text-gray-900 dark:text-white">{{ admins.from }}-{{ admins.to }}</span>
                            de
